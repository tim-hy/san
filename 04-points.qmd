...
```{r fig.margin=TRUE, fig.asp=1, fig.cap="KDE of AirBnb properties in San Diego"}
...
```{r fig.fullwidth=TRUE, fig.asp=1, fig.cap="KDE of AirBnb properties in San Diego", warning=FALSE, message=FALSE}
